...
/* Pulled from https://github.com/gulyasm/jsonui
   Leverages: https://github.com/jroimartin/gocui
   License: Apache 2.0
       https://raw.githubusercontent.com/suykerbuyk/jsonui/master/LICENSE.txt
*/
import (
	"fmt"
